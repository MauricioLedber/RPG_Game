...
public class IronBoots extends Armor implements Serializable {
    private int counter;

    public IronBoots() {

        super("Botas de Hierro",
                "Unas Botas de hierro que protege tus pies.", 10);
        this.counter = 0;
